...
This file asks for user input on how to run the program, and uses an if statement to control the Msize (will print "Entered invalid Msize number" if you enter a number outside the bounds (set between 0 and 100, but can be changed at line 23), and a switch statement with cases to navigate whether the user 
...
Lastly, the program will print "Time elapsed: (time) seconds" and give the user the wall time.
